    ...
    return (
        <Dialog open={open} onOpenChange={(open) => {
            ...
            <DialogTrigger asChild>
                <Button variant='default' size='sm' disabled={publishLoading || disabled}
                    className='cursor-pointer  bg-green-500 text-background hover:!bg-green-500/80' onClick={showDialog}>
                    Publish
                </Button>
            </DialogTrigger>
            <DialogContent onInteractOutside={(e) => e.preventDefault()}>
                ...
                <div className='flex flex-col gap-3'>
                    <div className='flex flex-col gap-2'>
                        <Label htmlFor="app-name" className='text-xs'>Website Title & Icon</Label>
                    ...
                    <div className='flex flex-col gap-2'>
                        <Label htmlFor="app-description" className='text-xs'>Description</Label>
                        <Input type='text' id='app-description' placeholder='APP Description' value={appDescription} onChange={(e) => setAppDescription(e.target.value)} />
                    </div>
                    <div className='flex flex-col gap-2'>
                        <Label htmlFor="app-url" className='text-xs'>URL</Label>
                        <div className='flex flex-row gap-2'>
                ...
                <DialogFooter >
                    <DialogClose asChild>
                        <Button variant='outline' size='sm'
                            className='cursor-pointer text-gray-500' onClick={() => setOpen(false)} disabled={publishLoading}>
                            Cancel
                        </Button>
                    </DialogClose>
                    <Button variant='outline' size='sm'
                            className='cursor-pointer text-gray-500' onClick={handleSaveSettings} disabled={publishLoading}>
                            Save Settings
                        </Button>
