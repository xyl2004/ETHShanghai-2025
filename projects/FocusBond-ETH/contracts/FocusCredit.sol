...
/**
 * @title FocusCredit
 * @dev Non-transferable credits for fee discounts in FocusBond
 * @notice These credits are earned through app usage and cannot be transferred
 */
contract FocusCredit is ERC20, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    
    address public focusBond;
    
    modifier onlyFocusBond() {
        require(msg.sender == focusBond, "FocusCredit: Only FocusBond can call this function");
        _;
    }
    
    constructor() ERC20("Focus Credit", "FCRED") {
    ...
    function transfer(address, uint256) public pure override returns (bool) {
        revert("FocusCredit: Token is non-transferable");
    }
