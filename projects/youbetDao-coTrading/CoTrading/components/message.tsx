      ...
      >
        ...
        >
          ...
          {(() => {
            ...
            return orderedParts.map((part: any, index: number) => {
              const { type } = part;
                      ...
                      {state === "output-available" && (
                        <ToolOutput
                          output={(() => {
                            ...
                            if (!out || "error" in out) return undefined;
                            const tvInterval =
                              out.interval === "1m"
                                ? "1"
                                : out.interval === "3m"
                            ...
                            return (
                              <TradingViewChart
                                symbol={out.symbol ?? "BTCUSDT"}
                                exchange={out.exchange ?? "BINANCE"}
                                interval={tvInterval}
                              />
                            );
                          })()}
                          errorText={
                            part.output && "error" in (part.output as any)
