...
import {IStakeManager} from "@account-abstraction-v8/contracts/interfaces/IStakeManager.sol";
 ...
 */
abstract contract BasePaymaster is Initializable, UUPSUpgradeable, Ownable2StepUpgradeable, PausableUpgradeable {
    // global entry point
