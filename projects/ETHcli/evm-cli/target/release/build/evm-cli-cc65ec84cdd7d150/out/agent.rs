        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn execute_action(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/agent.AgentService/ExecuteAction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("agent.AgentService", "ExecuteAction"));
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/agent.AgentService/ExecuteAction" => {
                    #[allow(non_camel_case_types)]
                    struct ExecuteActionSvc<T: AgentService>(pub Arc<T>);
                    impl<
                        T: AgentService,
                    > tonic::server::UnaryService<super::ActionRequest>
                    for ExecuteActionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentService>::execute_action(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
