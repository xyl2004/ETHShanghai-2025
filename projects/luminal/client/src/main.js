...
const Disclaimer = ({ Text, Link }) => (_jsxs(Text, { children: ["Zero-knowledge swap prototype. Review docs before committing funds.", " ", _jsx(Link, { href: "https://github.com/luminal", children: "Learn more" })] }));
