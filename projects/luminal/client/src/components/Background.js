...
export function Background() {
    return (_jsxs("div", { className: "absolute inset-0 -z-10 bg-[#08090C]", children: [_jsx("div", { className: "absolute inset-0 bg-uniswap-glow opacity-70 blur-[120px]" }), ORBS.map((orb, index) => (_jsx("span", { className: "absolute rounded-full", style: {
                    width: `${orb.size}px`,
                    height: `${orb.size}px`,
                    top: orb.top,
                    left: orb.left,
