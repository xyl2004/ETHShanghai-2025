export const EthereumTokens: { [symbol: string]: { address: string; decimals: number } } = {
  ...
  btcUSD: { decimals: 18, address: "0x9D11ab23d33aD026C466CE3c124928fDb69Ba20E" },
  ...
  fWBTC: { decimals: 18, address: "0x576b4779727F5998577bb4e25bf726abE742b9F7" },
  ffrxETH: { decimals: 18, address: "0xa87F04c9743Fd1933F82bdDec9692e9D97673769" },
  frxETH: { decimals: 18, address: "0x5e8422345238f34275888049021821e8e08caa1f" },
  fstETH: { decimals: 18, address: "0xD6B8162e2fb9F3EFf09bb8598ca0C8958E33A23D" },
  ...
  xWBTC: { decimals: 18, address: "0x9f23562ec47249761222EF7Ac02b327a8C45Ba7D" },
  xfrxETH: { decimals: 18, address: "0x2bb0C32101456F5960d4e994Bac183Fe0dc6C82c" },
  xstETH: { decimals: 18, address: "0x5a097b014C547718e79030a077A91Ae37679EfF5" },
...
EthereumTokens["CRV_2C_ETH/xETH_302"] = { decimals: 18, address: "0x16eAd9a10b1A77007E6E329B076aD1Fe97a6F7C0" };
EthereumTokens["CRV_2C_ETH/FXN_311"] = { decimals: 18, address: "0xE06A65e09Ae18096B99770A809BA175FA05960e2" };
// Curve TwoCrypto LP (including factory pools)
EthereumTokens["CRV_2C_WETH/ZUN_22"] = { decimals: 18, address: "0x9dbcfc09e651c040ee68d6dbeb8a09f8dd0caa77" };
// Curve TriCrypto LP (including factory pools)
EthereumTokens["CRV_3C_USDT/WBTC/ETH"] = { decimals: 18, address: "0xc4AD29ba4B3c580e6D59105FFf484999997675Ff" };
EthereumTokens["CRV_3C_USDC/WBTC/WETH_0"] = { decimals: 18, address: "0x7F86Bf177Dd4F3494b841a37e810A34dD56c829B" };
EthereumTokens["CRV_3C_USDT/WBTC/WETH_1"] = { decimals: 18, address: "0xf5f5B97624542D72A9E06f04804Bf81baA15e2B4" };
EthereumTokens["CRV_3C_crvUSD/tBTC/wstETH_2"] = { decimals: 18, address: "0x2889302a794dA87fBF1D6Db415C1492194663D13" };
EthereumTokens["CRV_3C_USDC/WETH/INV_3"] = { decimals: 18, address: "0x5426178799ee0a0181A89b4f57eFddfAb49941Ec" };
EthereumTokens["CRV_3C_crvUSD/WETH/CRV_4"] = { decimals: 18, address: "0x4eBdF703948ddCEA3B11f675B4D1Fba9d2414A14" };
EthereumTokens["CRV_3C_crvUSD/frxETH/Silo_11"] = { decimals: 18, address: "0x86bF09aCB47AB31686bE413d614E9ded3666a1d3" };
EthereumTokens["CRV_3C_wstETH/rETH/sfrxETH_14"] = { decimals: 18, address: "0x2570f1bD5D2735314FC102eb12Fc1aFe9e6E7193" };
EthereumTokens["CRV_3C_crvUSD/frxETH/SDT_16"] = { decimals: 18, address: "0x954313005C56b555bdC41B84D6c63B69049d7847" };
EthereumTokens["CRV_3C_DOLA/DBR/INV_18"] = { decimals: 18, address: "0xC7DE47b9Ca2Fc753D6a2F167D8b3e19c6D18b19a" };
